...
export default function WorkbenchHomeLayout() {
  const [selectedPkg, setSelectedPkg] = useState('UNI-BOR-ELE-001');

  const handleNextPriority = () => {
    notifications.show({
      title: 'Opening Priority Item',
      message: 'Navigating to IFC approval item for UNI-KEM-ELE-001.',
      color: 'green',
    });
  };
        ...
        <Group justify="space-between" align="flex-start" wrap="wrap" gap="md">
          <Box style={{ flex: 1 }}>
            <Title order={1} fz={{ base: 20, sm: 24 }} fw={700} c="#111827">
              Engineering Workbench Home
            </Title>
            <Text size="sm" c="#6b7280" mt={4} maw={720}>
              Provide a role-aware operational landing page showing priority engineering work, overdue reviews, pending approvals, blocked packages and the next executable action.
            </Text>
          </Box>
          <Button
            color="green"
      ...
      <Grid gutter="md" mb="md">
        <Grid.Col span={{ base: 6, sm: 3 }}>
          <Paper p="md" style={{ backgroundColor: '#ffffff', border: '1px solid #e5e7eb', borderRadius: 8 }}>
            <Text size="xs" fw={600} c="#6b7280" mb={4}>Assigned work count</Text>
        ...
        <Grid.Col span={{ base: 6, sm: 3 }}>
          <Paper p="md" style={{ backgroundColor: '#ffffff', border: '1px solid #e5e7eb', borderRadius: 8 }}>
            <Text size="xs" fw={600} c="#6b7280" mb={4}>P0/P1 blockers</Text>
        ...
        <Grid.Col span={{ base: 6, sm: 3 }}>
          <Paper p="md" style={{ backgroundColor: '#ffffff', border: '1px solid #e5e7eb', borderRadius: 8 }}>
            <Text size="xs" fw={600} c="#6b7280" mb={4}>Approvals due</Text>
        ...
        <Grid.Col span={{ base: 6, sm: 3 }}>
          <Paper p="md" style={{ backgroundColor: '#ffffff', border: '1px solid #e5e7eb', borderRadius: 8 }}>
            <Text size="xs" fw={600} c="#6b7280" mb={4}>EWP health summary</Text>
